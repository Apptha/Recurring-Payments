 ...
 */
class Apptha_Recurringpayments_Block_Adminhtml_Subscriptiontype extends Mage_Adminhtml_Block_Widget_Grid_Container {
	
	public function __construct() {
		$this->_controller = 'adminhtml_subscriptiontype';
		$this->_blockGroup = 'recurringpayments';
		$this->_headerText = Mage::helper ( 'recurringpayments' )->__ ( 'Subscription Type' );
