 ...
 */
class Apptha_Recurringpayments_Block_Adminhtml_Createsubscriptions_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form {
	/**
	...
	protected function _prepareForm() {
		...
		$fieldset->addField ( 'name', 'link', array (
				'label' => Mage::helper ( 'recurringpayments' )->__ ( 'Product Name' ),
				'name' => 'name',
				'value' => $linkedProduct 
		) );
		...
		$dayOfMonth = $fieldset->addField ( 'day_of_month', 'text', array (
